{{- define "kinetica-operators.saas-eks-dboperator-operator" }}
...
metadata:
  ...
  labels:
    ...
    helm.sh/chart: '{{ include "kinetica-operators.chart" . }}'
data:
  {{ (.Files.Glob "files/configmaps/saas-eks-dboperator-operator-kineticaoperator-config-map.yaml").AsConfig }}
